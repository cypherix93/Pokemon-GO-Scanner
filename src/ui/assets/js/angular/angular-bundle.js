...
AngularApp.controller("MapController", ["$scope", "$location", "MapObjectService", function MapController($scope, $location, MapObjectService)
{
    var self = this;
...
$templateCache.put('templates/app/map/Map.template.html','<location-search-component coords="Map.searchCoords"></location-search-component>\r\n\r\n<leaflet id="poke-map" center="Map.options.center" controls="Map.options.controls" defaults="Map.options.defaults" layers="Map.options.layers" markers="Map.markers">\r\n</leaflet>');
