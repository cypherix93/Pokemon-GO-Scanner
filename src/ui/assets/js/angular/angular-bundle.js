...
AngularApp.controller("HomeController", ["$scope", "$compile", "MapObjectService", "InfoWindowService", function HomeController($scope, $compile, MapObjectService, InfoWindowService)
{
    var self = this;
...
AngularApp.controller("MapController", ["$scope", "$location", function MapController($scope, $location)
{
    var self = this;
